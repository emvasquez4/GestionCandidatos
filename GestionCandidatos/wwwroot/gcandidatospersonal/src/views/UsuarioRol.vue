<template>
 ...
 <script>
   ...
   import CrearUsuario from '../components/UsuarioRol/UsuarioRol.vue'
   ...
   export default {
     ...
     async getPermisos() {
       try {
          await Services.UsuariosRolesService.getUserPermiso('CODUSUARIO', this.userId.toString(), 'USUARIOROL').
          then(async response => {
