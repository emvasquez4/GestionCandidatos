<template>
  <div>
   <Menu :menus="menus" />
   <BotonTitulo titulo="Gestión de Candidatos" :Permiso="nuevo" :PermisoFiltro="consultar" nombrebtn="Crear Candidatos"/>
 ...
 <script>
   ...
   import CrearEntrevistas from '../components/Candidatos/Candidatos.vue'
   ...
   export default {
     ...
     filtrarUsuarios({filtro, valorFiltrado}) {
        this.loading = true;
        Services.CandidatosService.getAll(filtro, valorFiltrado)
         .then(response => {
