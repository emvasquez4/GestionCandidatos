<template>
 <div>
  <Menu :menus="menus" />
  <BotonTitulo titulo="Gestión de candidatos" :Permiso="nuevo" :PermisoFiltro="consultar" nombrebtn="Crear candidato"/>
...
<script>
  ...
  import CrearUsuario from '../components/Candidatos/frmCandidatos.vue';
  ...
  export default {
    ...
    async getPermisos() {
      try {
         await Services.UsuariosRolesService.getUserPermiso('CODUSUARIO', this.userId.toString(), 'CANDIDATOS').
         then(async response => {
